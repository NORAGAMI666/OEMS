  ...
  if (@$_GET['q'] == 'addqns' && $_SESSION['key'] == 'sunny7785068889') {
    ...
    for ($i = 1; $i <= $n; $i++) {
      ...
      if (!$_FILES["fileToUpload" . $i]["name"]) {
        ...
        $q3 = mysqli_query($con, "INSERT INTO questions  (eid, qid, qns, choice, sn, filepath) VALUES  ('$eid','$qid','' , '0' , '$i', '$target_file')");
      }
    }
...
if (@$_GET['q'] == 'quiz' && @$_GET['step'] == 2) {
  ...
  if (!$_FILES["fileToUpload"]["name"]) {
    ...
    $q3 = mysqli_query($con, "INSERT INTO answer_scripts  (eid, qid, filepath, email) VALUES  ('$eid','$qid', '$target_file', '$email')");
  }
  if ($sn != $total) {
    $sn++;

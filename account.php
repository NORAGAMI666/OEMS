...
<head>
  ...
  <title>Online Examination System || Exam Dashboard </title>
...
<tr><td><b>S.N.</b></td><td><b>Topic</b></td><td><b>Total question</b></td><td><b>Marks</b></td><td><b>Time limit</b></td><td></td></tr>';
	...
	<td><b><a class="pull-right btn sub1" style="margin:0px;background:red"><span class="glyphicon glyphicon-ok-circle" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Done</b></span></a></b></td></tr>';
              }
            }
            $c = 0;
            echo '</table></div></div>';
          ...
          <span id="countdown" style="<?php echo $_GET['q'] !== 'quiz' ? 'display: none' : '' ?>" class="timer"></span>
          ...
          if (@$_GET['q'] == 'quiz' && @$_GET['step'] == 2) {
            ...
            echo '<form action="update.php?q=quiz&step=2&eid=' . $eid . '&n=' . $sn . '&t=' . $total . '&qid=' . $qid . '" method="POST" enctype="multipart/form-data"  class="form-horizontal"><br />';
            ...
            if ($ch !== "0") {
              ...
              echo "<a href='" . $filepath . "' download='Question" . $sn . "." . $extension .  "'><b>Download Question Paper</b></a><br /><br />";
          ...
          <script>
            ...
            $qcount = mysqli_query($con, "SELECT COUNT(*) as c FROM questions WHERE eid='$eid'") or die('Error');
            ...
            while ($row = mysqli_fetch_array($qcount)) {
              $count = $row["c"];
            }
            ?>
            var seconds = <?php echo $time * 60 ?>;
            //var_dump($time);
            const quiztime = localStorage.getItem('<?php echo $eid ?>')
            if (quiztime)
              seconds = seconds - Math.floor((Date.now() - quiztime) / 1000);
            else
              localStorage.setItem('<?php echo $eid ?>', Date.now())
            ...
            function secondPassed() {
              ...
              if (seconds == 0) {
                ...
                seconds--;
                //localStorage.setItem('<?php echo $eid ?>', )
              }
            }
          ...
          if (@$_GET['q'] == 'result' && @$_GET['eid']) {
            echo "<script>window.location.href='http://localhost/onlineexamination-master/account.php?q=1'</script>";
...
<center><h1 class="title" style="color:#660033">Result</h1><center><br /><table class="table table-striped title1" style="font-size:20px;font-weight:1000;">';
	  ...
	  <tr style="color:#66CCFF"><td>Score&nbsp;<span class="glyphicon glyphicon-star" aria-hidden="true"></span></td><td>' . $s . '</td></tr>';
            ...
            while ($row = mysqli_fetch_array($q)) {
              ...
              //$tot = $row['totalmarks'];
              echo '<tr style="color:#990000"><td>Overall Score&nbsp;<span class="glyphicon glyphicon-stats" aria-hidden="true"></span></td><td>' . $s+$th . '</td></tr>';
            }
            echo '</table></div>';
          }
          ?>
...
<tr style="color:red"><td><b>Rank</b></td><td><b>Name</b></td><td><b>Email</b></td><td><b>Score</b></td></tr>';
            ...
            while ($row = mysqli_fetch_array($q)) {
              ...
              $c++;
              echo '<tr><td style="color:#99cc32"><b>' . $c . '</b></td><td>' . $name . '</td><td>' . $e . '</td><td>'/*. $gender . '</td><td>' . $college . '</td><td>' */ . $s . '</td><td>';
            }
            echo '</table></div></div>';
          }
          ?>

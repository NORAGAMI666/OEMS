...
<body>
  ...
  <div class="bg1">
    <div class="row">
      ...
      <div class="col-md-6 panel" style="background-image:url(image/bg1.jpg); min-height:420px;">
...
<div class="col-md-10">
<a href="mailto:sharanya8501@gmail.com" style="color:#000000"><b>pakhishreya@gmail.com</b></a><br /><br />
...
<input type="submit" name="submit" value="Submit" class="btn btn-primary" />
  ...
  <div class="row footer">
    ...
    <!--<div class="col-md-3 box">
      <<<<<<< HEAD <a href="#" data-toggle="modal" data-target="#developers">Developers</a>
        =======
        <a href="#" data-toggle="modal" data-target="#developers">Developer</a>
        >>>>>>> 5a1c4518e0ca7c47668f0cf5c5a7f2aec9f41fa7
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <<<<<<< HEAD <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange">Developers</span></h4>
            =======
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-md-4">
              <<<<<<< HEAD <img src="image/CAM00121.jpg" width=100 height=100 alt="Sunny Prakash Tiwari" class="img-rounded">
            </div>
            <div class="col-md-5">

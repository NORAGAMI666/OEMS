    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
          ...
          <li <?php if (@$_GET['q'] == 1) echo 'class="active"'; ?>><a href="dash.php?q=1">Students List</a></li>
          ...
          <li <?php if (@$_GET['q'] == 7) echo 'class="active"'; ?>><a href="dash.php?q=7">Answer Scripts</a></li>
...
<tr><td><b>S.N.</b></td><td><b>Topic</b></td><td><b>Total question</b></td><td><b>Marks</b></td><td><b>Time limit</b></td><td></td></tr>';
          ...
          while ($row = mysqli_fetch_array($result)) {
            ...
            if ($rowcount == 0) {
              echo '<tr><td>' . $c++ . '</td><td>' . $title . '</td><td>' . $total . '</td><td>' . $sahi * $total + $theory . '</td><td>' . $time . '&nbsp;min</td>
...
<tr style="color:red"><td><b>Rank</b></td><td><b>Name</b></td><td><b>Email</b></td><td><b>Score</b></td></tr>';
          ...
          while ($row = mysqli_fetch_array($q)) {
            ...
            $c++;
            echo '<tr><td style="color:#99cc32"><b>' . $c . '</b></td><td>' . $name . '</td><td>' . $e . '</td><td>'/*. $gender . '</td><td>' . $college . '</td><td>'*/ . $s+$th . '</td><td>';
          }
          echo '</table></div></div>';
        }
...
<tr><td><b>S.N.</b></td><td><b>Name</b></td><td><b>Gender</b></td><td><b>Email</b></td><td><b>Mobile</b></td><td></td></tr>';
	...
	<td><a title="Delete User" href="update.php?demail=' . $email . '"><b><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></b></a></td></tr>';
        ...
        <?php if (@$_GET['q'] == 3) {
          ...
          echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Email</b></td><td><b>Date</b></td><td><b>Time</b></td><td><b>By</b></td><td></td><td></td></tr>';
          $c = 1;
          while ($row = mysqli_fetch_array($result)) {
            $date = $row['date'];
            ...
            $id = $row['id'];
            echo '<tr><td>' . $c++ . '</td>';
            echo '<td><a title="Click to open feedback" href="dash.php?q=3&fid=' . $id . '">' /*. $subject . '</a></td><td>'*/ . $email . '</a></td><td>' . $date . '</td><td>' . $time . '</td><td>' . $name . '</td>
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-12 control-label" for="theorymarks"></label>  
  <div class="col-md-12">
  <input id="theorymarks" name="theorymarks" placeholder="Enter full marks for theory paper(if any)" class="form-control input-md" min="0" type="number">
...
<input type="file" name="fileToUpload' . $i . '" id="fileToUpload' . $i . '">
...
<select id="ans' . $i . '" name="ans' . $i . '" placeholder="Choose correct answer " class="form-control input-md" >
  ...
  <label class="col-md-12 control-label" for=""></label>
  <div class="col-md-12"> 
    <input  type="submit" style="margin-left:45%; margin-bottom:100px" class="btn btn-primary" value="Submit" class="btn btn-primary"/>
  </div>
</div>
</fieldset>
</form></div>';
...
<tr><td><b>S.N.</b></td><td><b>Topic</b></td><td><b>Total question</b></td><td><b>Marks</b></td><td><b>Time limit</b></td><td></td></tr>';
	...
	<td><b><a href="update.php?q=rmquiz&eid=' . $eid . '" class="pull-right btn sub1" style="margin:0px;background:red"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Remove</b></span></a></b></td></tr>';
        ...
        <!--answer scripts-->
        <?php if (@$_GET['q'] == 7) {
          $result = mysqli_query($con, "SELECT * FROM `answer_scripts`") or die('Error');
         ?>
          ...
          <table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Subject</b></td><td><b>Email</b></td><td><b>Date</b></td><td><b>Time</b></td><td><b>Download Answer Script</b></td><td><b>&nbsp;&nbsp;Enter Marks Obtained</b></td><td></td></tr>';
          $c = 1;
          while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {

            $quiz = mysqli_query($con, "SELECT title from quiz where eid = '" . $row['eid'] . "'");
            $qrow = mysqli_fetch_array($quiz, MYSQLI_ASSOC);
            $timestamp = $row['time'];
            $date = date("d-m-Y", strtotime($timestamp));
            $time = date("H:m:s", strtotime($timestamp));
            $subject = $qrow['title'];
            $email = $row['email'];
            $id = $row['id'];
            ...
            echo '<td>
            		<a title="Click to open feedback" href="dash.php?q=3&fid=' . $id . '">' . $subject . '</a></td><td>' . $email . '</td><td>' . $date . '</td><td>' . $time . '
            	  </td>';
			echo '<td>
				  	<a title="Open Feedback" href="' . $filepath . '" download="' . $subject . "-" . $email . "." . $extension . '"><b><span class="glyphicon glyphicon-arrow-down" aria-hidden="true"></span></b></a>
				  </td>';
			echo  " ";
			?> 
			 	<td>
					<!-- Text input-->
					<div class="form-group">
						<label class="col-md-12 control-label" for="ansscriptmarks">
						</label>  
					    	<div class="col-md-10">
					    		<input name="check[]" placeholder="Enter marks" class="form-control input-md" min="0" type="number" value="<?php  echo $row["id"]; ?>">
					    	</div>
					</div>
				</td>;
				  <?php
		  ...
		  <label class="col-md-10 control-label" for=""></label>
		    <div class="col-md-8"> 
		    <input type="submit" style="margin-left:0%;" class="btn btn-primary" name="sub1" value="Update" class="btn btn-primary"/>
		    </div>
		  </div>
		  </form>
		 <?php 
	  			...
	  			if(isset($_POST['sub1']))
	  			{
	  				if(isset($_POST['check']))
	  				{
	  					foreach ($_POST['check'] as $delete_id) {
	  						mysqli_query($con, "UPDATE answer_scripts SET ansscriptmarks = '100' WHERE `id` = '$delete_id' ;");
	  					}
	  				}
	  			}
        ?>
